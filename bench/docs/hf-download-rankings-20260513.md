...
| ---: | --- | ---: | ---: | --- | --- | --- |
| 1 | `Youssofal/Qwen3.6-35B-A3B-Abliterated-Heretic-MLX-4bit` | `21,866` | `16` | `false` | `false` | `DFlash` は `12/25` まで有効、`4/25` 成功。`DDTree` は `10/25` まで有効、`6/25` 成功。rest-per-exercise 継続中 |
...
- `DFlash + Youssofal` は `4/25`、`DDTree + Youssofal` は `6/25` まで確定。DDTree は `food-chain` 以降を 1 exercise = 1 server で再評価中です。
