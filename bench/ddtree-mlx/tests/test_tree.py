...
from ddtree_mlx.dflash_compat import make_target_cache, target_forward_with_hidden_states
...
def test_tree_aware_verify_matches_sequential_path_logits():
    ...
    model = _DFlashTextWrapper(TextModel(args).model)
    root_token = 1
