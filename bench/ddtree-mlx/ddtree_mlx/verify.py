...
from .dflash_compat import (
    HYBRID_SDPA_EXACT_KV_THRESHOLD,
    logits_from_hidden,
    split_sdpa_output,
    target_text_model,
)
...
def _attention_forward_with_tree(
    ...
    *,
    ...
    if tree_mask_only:
        ...
        should_split = (
            cache is not None
            and cached_prefix_len >= HYBRID_SDPA_EXACT_KV_THRESHOLD
...
def tree_verify_forward(
    ...
    *,
    ...
    inner = target_text_model(target_model)
    ...
    logits = logits_from_hidden(target_model, normalized)
